...
describe("SubSetSum", function () {
  xit("should return true as 1 + 5 + 3 equals 9", function () {
    expect(subSetSum([1, 10, 5, 3], 9)).to.equals(true);
  });
  xit("should return true as 1 + 10 + 5 + 3 equals 19", function () {
    expect(subSetSum([1, 10, 5, 3], 19)).to.equals(true);
  });
  xit("should return fale as we can not sum 2", function () {
    expect(subSetSum([1, 10, 5, 3], 2)).to.equals(false);
  });
  xit("should return true as 10 + 0 equals 10", function () {
