...
describe("MultidimensionalSumArray", function () {
  xit("should return the sum of all numbers of a simple array", function () {
    expect(mdArraySum([1, 2, 3, 4])).to.equal(10);
  });
  xit("should return the sum of all numbers of an array of arrays", function () {
    expect(mdArraySum([[2, 4], [1], [4, 2, 1]])).to.equal(14);
  });
  xit("should return the sum of all numbers of a multidensional array", function () {
