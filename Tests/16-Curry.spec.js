...
describe("Curring", function () {
  ...
  xit("next calls should return a function if not all the arguments where provided", function () {
  ...
  xit("should return the result of curried function when all the arguments are provided", function () {
    const curriedDoSomething = curry(calcAllFour);
    const firstReturn = curriedDoSomething(1);
