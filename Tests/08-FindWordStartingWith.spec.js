...
describe("FindWordStartingWith", function () {
  ...
  xit("should return all the indexes of words starting with 'de'", () => {
    expect(FindWordStartingWith(book, "de")).to.deep.equal([23]);
  });
  xit("should return all the indexes of words starting with 'un'", () => {
    expect(FindWordStartingWith(book, "un")).to.deep.equal([6, 14, 43]);
  });
  xit("should return an empty array if the word is not in the book", () => {
